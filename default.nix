...
let
  ...
  packages = packageSpecs (deps' // {
    ...
    dss-deploy-liq-2-0-runs-1 = deps'.dss-deploy-liq-2-0 // { name = "dss-deploy-liq-2-0-runs-1";   solcFlags = "--optimize --optimize-runs 1"; solc = solc-static-versions.solc_0_6_12; };
  });
