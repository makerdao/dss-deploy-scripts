...
echo "KOVAN LIKE PREP COMPLETED SUCCESSFULLY"
echo "*****************************************************************"
echo "*****                    STEPS TAKEN                        *****"
echo "*****************************************************************"
...
echo "*****************************************************************"
echo "*****           You can now run ./deploy-kovan.sh           *****"
echo "*****                                                       *****"
echo "*****                                                       *****"
echo "*****             Afterwards you should run                 *****"
echo "*****         ./scripts/setup/reset-kovan-like.sh           *****"
echo "*****          to restore the kovan deploy config            *****"
echo "*****************************************************************"
