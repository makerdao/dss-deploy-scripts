...
echo "Using Infura to deploy on MAINNET"

# Set dapptools environment variables
export ETH_RPC_URL="https://mainnet.infura.io/v3/" # add your Infura token when you deploy and remove before you push code
