# This file has been generated by dapp2nix 0.0.3, do not edit.
...
let
  ...
  specs = rec {
    ...
    testchain-dss-deployment-scripts_d56cb91 = rec {
      name = "testchain-dss-deployment-scripts";
      deps = {
        ds-chief = ds-chief_58a02ff;
        ds-guard = ds-guard_4678e1c;
        dss-deploy = dss-deploy_b7c10aa;
      ...
      repo' = {
        name = "testchain-dss-deployment-scripts-d56cb91-source";
        url = "git@github.com:makerdao/testchain-dss-deployment-scripts";
        rev = "d56cb9131e83a82eca1506c69398017300ac1b8b";
        ref = "nixify-poc";
      };
      src' = fetchGit repo';
      src = "${src'}/src";
    };
    this = testchain-dss-deployment-scripts_d56cb91 // { src' = ./.; src = ./src; };
  };
in {
